================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Number Project Overview
===============================================================================

The application wizard has created this Number application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Number application.
...
res\Number.ico
    ...
    icon is included by the main resource file Number.rc.
...
NumberDlg.h, NumberDlg.cpp - the dialog
    These files contain your CNumberDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in Number.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CNumberDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Number.pch and a precompiled types file named StdAfx.obj.
